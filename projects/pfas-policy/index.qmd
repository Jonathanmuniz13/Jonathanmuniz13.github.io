---
title: "PFAS Policy Across the U.S.: Analysis and Visualization for a Narrative Review"
description: "The data analysis and all data visualization for a narrative review of PFAS regulatory policy in U.S. drinking water and food, turning a fragmented, 85-instrument policy landscape into five figures that make the story legible. Manuscript in preparation."
image: pfas-state-comparison.png
date: 2026-03-01
categories: [Data Visualization, Geospatial, R, Public Health Policy]
---
...
![Evolution of federal PFAS drinking-water advisories and standards, 2009 to 2024, on a log scale](pfas-federal-timeline.png){fig-alt="Log-scale step chart of federal PFOA and PFOS thresholds dropping from 400 ppt to 4 ppt between 2009 and 2024"}
...
![State-by-state PFAS maximum contaminant levels compared to the federal standard](pfas-state-comparison.png){fig-alt="Cleveland dot plot comparing state PFAS maximum contaminant levels against the 4.0 ppt federal standard on a log scale"}
...
![Choropleth map of U.S. states classified by type of PFAS policy instrument](pfas-choropleth.png){fig-alt="Color-coded U.S. map showing each state's PFAS policy instrument type, with many states having no identified activity"}
...
![Stacked bar chart of PFAS policy instruments by year, 2002 to 2026, split by exposure pathway](pfas-temporal.png){fig-alt="Stacked bar chart showing PFAS policy instruments per year sharply increasing after 2020"}
...
![Roadmap of key federal PFAS regulatory milestones from 2002 to 2024](pfas-roadmap.png){fig-alt="Timeline roadmap of federal PFAS regulatory milestones between 2002 and 2024"}
...
- 🖼️ [View Poster 1: PFAS thresholds, limits and advisories (PNG)](pfas-poster-1.png) covers the federal timeline, state comparison, and cross-jurisdictional tables
- 🖼️ [View Poster 2: Policies and regulatory instruments, a narrative review (PNG)](pfas-poster-2.png) covers the choropleth map, temporal trends, and federal milestone roadmap
- 💻 [Code on GitHub](https://github.com/Jonathanmuniz13/pfas-policy-figures)
